...
const app = express()
const url = 'mongodb+srv://superadmin:020842@cluster0.vjb0a.mongodb.net/sample_weatherdata?retryWrites=true&w=majority'
const client = new MongoClient(url, { userNewUrlParser: true, userUnifiedTopology : true })
